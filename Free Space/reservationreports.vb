...
Public Class reservationreports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Free_Space.reservationreports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreservationreports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reservationreports = New reservationreports()
        rpt.Site = Me.Site
        Return rpt
    End Function
