...
Public Class SCIENTIAHALL2reports
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SCIENTIAHALL2reports.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Free_Space.SCIENTIAHALL2reports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSCIENTIAHALL2reports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SCIENTIAHALL2reports = New SCIENTIAHALL2reports()
        rpt.Site = Me.Site
        Return rpt
    End Function
