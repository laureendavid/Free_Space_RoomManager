...
Public Class EDTECHreports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Free_Space.EDTECHreports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEDTECHreports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EDTECHreports = New EDTECHreports()
        rpt.Site = Me.Site
        Return rpt
    End Function
