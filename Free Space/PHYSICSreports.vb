...
Public Class PHYSICSreports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Free_Space.PHYSICSreports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPHYSICSreports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PHYSICSreports = New PHYSICSreports()
        rpt.Site = Me.Site
        Return rpt
    End Function
