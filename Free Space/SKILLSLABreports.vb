...
Public Class SKILLSLABreports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Free_Space.SKILLSLABreports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSKILLSLABreports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SKILLSLABreports = New SKILLSLABreports()
        rpt.Site = Me.Site
        Return rpt
    End Function
