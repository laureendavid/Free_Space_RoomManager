...
Public Class ARETEHALLreports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Free_Space.ARETEHALLreports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedARETEHALLreports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ARETEHALLreports = New ARETEHALLreports()
        rpt.Site = Me.Site
        Return rpt
    End Function
