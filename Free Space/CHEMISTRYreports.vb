...
Public Class CHEMISTRYreports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Free_Space.CHEMISTRYreports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCHEMISTRYreports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CHEMISTRYreports = New CHEMISTRYreports()
        rpt.Site = Me.Site
        Return rpt
    End Function
