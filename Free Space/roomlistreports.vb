...
Public Class roomlistreports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Free_Space.roomlistreports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedroomlistreports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As roomlistreports = New roomlistreports()
        rpt.Site = Me.Site
        Return rpt
    End Function
