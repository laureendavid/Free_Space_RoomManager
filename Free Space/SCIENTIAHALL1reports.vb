...
Public Class SCIENTIAHALL1reports
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SCIENTIAHALL1reports.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Free_Space.SCIENTIAHALL1reports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSCIENTIAHALL1reports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SCIENTIAHALL1reports = New SCIENTIAHALL1reports()
        rpt.Site = Me.Site
        Return rpt
    End Function
