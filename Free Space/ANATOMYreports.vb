...
Public Class ANATOMYreports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Free_Space.ANATOMYreports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedANATOMYreports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ANATOMYreports = New ANATOMYreports()
        rpt.Site = Me.Site
        Return rpt
    End Function
